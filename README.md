...
measured uncompute, an exact semiclassical-QFT phase shell, and an executable
interface-borrowed point-add leaf that reuses `lookup_x` as scratch after the
lookup coordinate has been consumed.
