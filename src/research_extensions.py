...
def compute_literature_projection_scenarios(repo_root: Path) -> Dict[str, Any]:
    ...
    result = {
        ...
        "takeaways": [
            ...
            "The signed two's-complement lookup-folding optimization provides an exact audited lookup-contract layer for the current modeled totals.",
...
def run_research_pass(repo_root: Path) -> Dict[str, Any]:
    ...
    result = {
        ...
        "lookup_folding": {
            ...
            "pad0_gain_vs_google_low_qubit_2channel": base_pad0["gain_vs_google_low_qubit_2channel"],
            "pad0_gain_vs_google_low_gate_2channel": base_pad0["gain_vs_google_low_gate_2channel"],
        },
        "challenge_ladder": {
