...
def test_engine_completion_audit_reconstructs_checked_artifact() -> None:
    ...
    assert remaining['modular_arithmetic_clifford_expansion']['status'] == 'local_modular_primitive_streams_bound_to_public_engine_rows_not_one_global_semantic_schedule'
