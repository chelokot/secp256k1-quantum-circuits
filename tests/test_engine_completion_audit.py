...
def test_engine_completion_audit_reconstructs_checked_artifact() -> None:
    ...
    materialized = _load('public_candidate_materialized_circuit_manifest.json')['materialized_flat_netlist']
...
def test_engine_completion_audit_rejects_public_total_drift() -> None:
    ...
    assert observed['checks']['public_totals_derive_from_materialized_flat_netlist'] is False
