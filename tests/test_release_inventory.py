...
class ReleaseInventoryTests(unittest.TestCase):
    def test_core_repository_inventory_is_present(self):
        expected = [
            ...
            'artifacts/public_envelope/low_gate_circuit.json',
            'artifacts/public_envelope/audit_low_qubit.csv',
            'artifacts/public_envelope/audit_low_gate.csv',
            'artifacts/exact_kickmix/out/pointadd_exact_kickmix.json',
            'artifacts/exact_kickmix/out/pointadd_audit_9024.csv',
            'artifacts/exact_kickmix/out/ecdlp_scaffold_exact_sample.json',
            'artifacts/exact_kickmix/out/proof_manifest.json',
            'artifacts/exact_kickmix/out/proof_sketch.md',
            'artifacts/exact_kickmix/out/toy_curve_exhaustive.json',
            'artifacts/optimized/out/optimized_pointadd_secp256k1.json',
            'artifacts/optimized/out/optimized_pointadd_family.json',
            'artifacts/optimized/out/optimized_pointadd_audit_16384.csv',
            'artifacts/optimized/out/ecdlp_scaffold_optimized.json',
            'artifacts/optimized/out/resource_projection.json',
            'artifacts/optimized/out/register_map.json',
            'artifacts/optimized/out/proof_manifest.json',
            ...
            'artifacts/optimized/out/claim_boundary_matrix.json',
            'artifacts/optimized/out/meta_analysis.json',
            'artifacts/optimized/out/optimization_frontier_estimates.json',
    ...
    def test_machine_readable_summaries_are_deterministic(self):
        ...
        rebuild = json.loads((REPO_ROOT / 'artifacts' / 'optimized' / 'out' / 'verifier_rebuild_summary.json').read_text())
