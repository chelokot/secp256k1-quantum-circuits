...
class ResearchArtifactTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.lookup_summary = json.loads((REPO_ROOT / 'artifacts' / 'out' / 'lookup_signed_fold_summary.json').read_text())
        cls.lookup_projection = json.loads((REPO_ROOT / 'artifacts' / 'out' / 'lookup_folded_projection.json').read_text())
