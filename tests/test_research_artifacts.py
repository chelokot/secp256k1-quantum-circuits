...
class ResearchArtifactTests(unittest.TestCase):
    ...
    def test_lookup_folding_projection_is_meaningful(self):
        ...
        self.assertGreater(base['improvement_fraction_vs_unfolded_reference_2channel'], 0.05)
        self.assertGreater(base['improvement_fraction_vs_unfolded_reference_3channel_conservative'], 0.08)
