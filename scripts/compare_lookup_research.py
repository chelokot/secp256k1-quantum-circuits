...
def main() -> None:
    ...
    print('---------------------------------------')
    print(f"2-channel folded total: {base['total_non_clifford_2channel_folded']:,}  improvement vs pre-folding baseline: {100.0 * base['improvement_fraction_vs_pre_folding_baseline_2channel']:.2f}%")
    print(f"3-channel conservative folded total: {base['total_non_clifford_3channel_folded_conservative']:,}  improvement vs pre-folding baseline: {100.0 * base['improvement_fraction_vs_pre_folding_baseline_3channel_conservative']:.2f}%")
    print()
