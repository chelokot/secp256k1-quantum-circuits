...
def main() -> None:
    ...
    print('---------------------------------------')
    print(f"2-channel folded total: {base['total_non_clifford_2channel_folded']:,}  improvement vs unfolded reference: {100.0 * base['improvement_fraction_vs_unfolded_reference_2channel']:.2f}%")
    print(f"3-channel conservative folded total: {base['total_non_clifford_3channel_folded_conservative']:,}  improvement vs unfolded reference: {100.0 * base['improvement_fraction_vs_unfolded_reference_3channel_conservative']:.2f}%")
    print()
