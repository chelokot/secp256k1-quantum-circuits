...
def main() -> None:
    ...
    print()
    print('Modeled folded branch (pad = 0)')
    print('-------------------------------')
    print(f"2-channel folded total: {base['total_non_clifford_2channel_folded']:,}  improvement: {100.0 * base['improvement_fraction_vs_current_2channel']:.2f}%")
    print(f"3-channel conservative folded total: {base['total_non_clifford_3channel_folded_conservative']:,}  improvement: {100.0 * base['improvement_fraction_vs_current_3channel_conservative']:.2f}%")
    print()
