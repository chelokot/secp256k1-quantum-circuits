...
- `public_engine_manifest.json` — no-ZKP public engine manifest binding executable instruction/wire/schedule/owner/resource-term streams, the public-candidate materialized stream and flat execution probe, semantic-boundary evidence, and primitive-operation evidence from arithmetic operation IR, QROAM primitive certificate, and phase-shell lowering
