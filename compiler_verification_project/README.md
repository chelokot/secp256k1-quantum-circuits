...
- the public materialized-engine manifest binds those local modular streams to
  arithmetic engine kernels, public arithmetic rows, exact operand domains, and
  strict liveness rows;
