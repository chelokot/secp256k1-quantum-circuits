...
PYTEST_TARGETS = (
    ...
    'tests/test_proof_environment_contract.py::test_proof_environment_contract_matches_generator',
    'tests/test_proof_environment_contract.py::test_proof_environment_contract_has_no_implicit_prover_commands',
    'tests/test_proof_publication_status.py::test_proof_status_script_matches_library_report',
