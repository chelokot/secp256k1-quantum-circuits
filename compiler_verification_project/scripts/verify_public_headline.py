...
def build_metadata_report() -> dict[str, Any]:
    ...
    check(checks, 'reusable_chunk_resource_contract_engine_unifies_counted_and_executable_liveness', resource_contract_engine['pass'] is True and resource_contract_engine['peak_live_qubits'] == public_values['expected_total_logical_qubits'] and resource_contract_engine['owner_peak_live_qubits'] == resource_contract_engine['owner_capacity_qubits'], {'logical_qubits': public_values['expected_total_logical_qubits'], 'owner_peak_equals_capacity': True}, resource_contract_engine)
