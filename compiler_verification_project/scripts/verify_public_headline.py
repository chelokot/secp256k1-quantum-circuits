...
def build_metadata_report() -> dict[str, Any]:
    ...
    check(checks, 'reusable_chunk_executable_resource_engine_binds_public_totals', executable_resource_engine['schema'] == 'compiler-project-executable-resource-engine-v1' and executable_resource_engine['pass'] is True and executable_resource_engine['public_totals']['non_clifford'] == selected['non_clifford'] and executable_resource_engine['public_totals']['logical_qubits'] == selected['logical_qubits'] and executable_resource_engine['counted_resource_ir_sha256'] == lowering['counted_resource_engine']['counted_resource_ir_sha256'] and executable_resource_engine['executable_liveness_sha256'] == resource_contract_engine['executable_liveness_sha256'], 'single executable resource engine summary matches public totals and resource digests', executable_resource_engine)
