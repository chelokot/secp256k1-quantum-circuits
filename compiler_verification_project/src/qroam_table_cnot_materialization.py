    ...
    *,
    ...
    return {
        ...
        'notes': [
            ...
            'The artifact records global emitted-CNOT operation ranges, rank checkpoints, and an executable per-CNOT row decoder for each segment; materialized_circuit.py splices these indexed rows into the canonical physical flat stream and exports decoded slices through materialize_exact_circuits.py.',
        ],
    }
