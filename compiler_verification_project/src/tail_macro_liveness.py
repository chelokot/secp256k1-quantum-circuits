...
def build_tail_macro_liveness(field_bits: int, counted_arithmetic_slots: int) -> Dict[str, Any]:
    ...
    return {
        ...
        'notes': [
            ...
            'The single-assignment formula DAG peaks above the counted three arithmetic slots, so the current headline still requires a separately generated destructive/recompute macro schedule or a different resource point.',
